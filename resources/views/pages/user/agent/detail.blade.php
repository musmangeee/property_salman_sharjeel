    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-6">
                <h2>{{$user->b_name}}</h2>
                <div class="callagen"><i class="fa fa-phone" aria-hidden="true"></i> {{$user->b_contact_no}}</div>
                ...
                <div class="location"><i class="fa fa-map-marker" aria-hidden="true"></i> {{$user->b_address1}}</div>                        
    ...
    <div class="modal-dialog"> 
        ...
        <div class="modal-content">
            <div class="modal-header">                  
                <h4 class="modal-title">Contact {{$user->b_name}}</h4>
...
<div class="searchlisting">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="statepgdt">
                    <h2 class="maintitle">Recent Properties by {{$user->b_name}}</h2>
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mainimage"><a href="detail.html"><img src="{{URL::asset('property/images/property/thumb-01.jpg') }}" alt="">
                                            ...
                                            <a href="#" class="favico slct" data-toggle="tooltip" data-placement="top" title="Save Property"><i class="fa fa-heart-o" aria-hidden="true"></i></a> 
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="listinner">
                                            <h2><a href="detail.html">{{$item->bed}} bed <b>{{$item->propertyType->name}}</b> house for sale</a></h2>
                                            ...
                                            <div class="postedon">{{$item->created_at->format('d-M-Y')}} by <a href="#">{{$item->User->name}} {{$item->User->lname}}</a></div>
                                            
                                            <div class="viiewoptions"><a href="{{route('user.property.show', $item->id)}}"><i class="fa fa-external-link-square"></i> View Details</a>  <a href="#." class="phone"><i class="fa fa-phone"></i> Show Number</a> </div>
