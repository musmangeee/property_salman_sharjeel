                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="formrow">
                                        ...
                                        <input type="text" class="form-control" value="{{$profile->contact_no}}" name="contact_no" placeholder="Enter Mobile Number" data-parsley-trigger="keyup" data-parsley-required="true">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="formrow">
